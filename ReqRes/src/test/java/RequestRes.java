...
public class RequestRes {
    ...
    public void registerUser(){
        ...
        Response res = given()
                ...
                .when()
                .post("register");
        Assert.assertEquals(res.statusCode(),200 , "Registration unsuccesful");
        System.out.println(res.getBody().asString());
    ...
    public void registerNotSucceseful(){
        ...
        Response res = given()
                ...
                .when()
                .post("register");
        Assert.assertEquals(res.statusCode(),400 , "Registration unsuccesful because password missing!");
        System.out.println(res.getBody().asString());
    ...
    public void loginSucceseful(){
        ...
        Response res = given()
                ...
                .when()
                .post("login");
        Assert.assertEquals(res.statusCode(),200 , "login unsuccesful");
        System.out.println(res.getBody().asString());
    ...
    public void loginUnSucceseful(){
        ...
        Response res = given()
                ...
                .when()
                .post("login");
        Assert.assertEquals(res.statusCode(),400 , "login unsuccesful because Password missing!");
        System.out.println(res.getBody().asString());
